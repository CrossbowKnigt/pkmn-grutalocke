...
def defaultBanner
  ...
  when (0...46) #Tier 1 con un 35%
    rewards = [:POTION, :ANTIDOTE, :PARALYZEHEAL, :BURNHEAL, :ICEHEAL, :AWAKENING, :POKEBALL, :ORANBERRY, :PECHABERRY, :CHERIBERRY, :CHESTOBERRY, :RAWSTBERRY, :ASPEARBERRY, :PERSIMBERRY, :BERRYJUICE, :REPEL, :TINYMUSHROOM, :STARDUST, :ETHER, :ELIXIR, :LEPPABERRY]
